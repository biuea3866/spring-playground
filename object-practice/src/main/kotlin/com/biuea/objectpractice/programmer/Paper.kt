...
abstract class Client(
    ...
    val language: Language = Language("kotlinJS"),
): Paper {
    lateinit var _programmer: Programmer<Paper>
}

abstract class ServerClient(
    var server: Server = Server("Spring"),
    val backendLanguage: Language = Language("kotlin"),
    val frontendLanguage: Language = Language("kotlinJS"),
): Paper {
    lateinit var _backendProgrammer: Programmer<Paper>
    lateinit var _frontendProgrammer: Programmer<Paper>
}